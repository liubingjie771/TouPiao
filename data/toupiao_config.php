...
/**tp_mulu***************************************************************************************************************************************************************************
  tp_id    | tp_title       | tp_start     | tp_end       | tp_min       | tp_max       |  tp_view_stop    |     tp_pass    | tp_znum  |  tp_cuser    | tp_ctime     | tp_bakinfo 
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
投票目录号 | 投票问题的标题 | 投票开始时间 | 投票结束时间 | 投票最小选项 | 投票最大选项 | 查看结果截止日期 | 投票者验证密码 | 投票总数 | 发布用户别名 | 投票创建时间 | 投票备注
*************************************************************************************************************************************************************************************/
$istb[0]="drop table tp_mulu";
$istb[1]="create table tp_mulu(tp_id int unique,tp_title varchar(100) not null,tp_start datetime not null,tp_end datetime not null,tp_min int not null,tp_max int not null,tp_view_stop datetime ,tp_pass varchar(100) not null,tp_znum int not null,tp_cuser varchar(50) not null,tp_ctime datetime not null,tp_bakinfo varchar(1000))";
$istb[2]="insert into tp_mulu values(1000,'测试投票标题一','2019-02-01 00:00:00','2019-02-28 23:59:59','2','3','2019-04-30 23:59:59','".sha1("891021")."',4,'投票管理员','2019-01-31 08:32:33','')";
$istb[20]="insert into tp_mulu values(1001,'测试已结束的投票标题','2019-04-12 00:00:00','2019-04-12 23:59:59','1','2','2019-04-30 23:59:59','".sha1("891021")."',5,'投票管理员','2019-01-31 08:32:33','')";
$istb[21]="insert into tp_mulu values(1002,'测试未开始的投票标题','2029-03-01 00:00:00','2029-03-31 23:59:59','1','2','2019-04-30 23:59:59','".sha1("891021")."',0,'投票管理员','2019-01-31 08:32:33','')";
/**tp_mlst********************************************************************************
